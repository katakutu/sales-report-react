          ...
          <form>
            ...
            <div className='dp--lembaga'>
              ...
              <div className='dp-lembaga-tab-content'>
                <div className={classNames('u-clearfix', 'u-relative', 'dp-lembaga-content', {'u-hide': this.state.activeContent !== 'baznas'})}>
                ...
                <div className={classNames('u-clearfix', 'u-relative', 'dp-lembaga-content', {'u-hide': this.state.activeContent !== 'ycab'})}>
                  <div className='u-relative u-mb2 u-center dp-lembaga-content-img'>
                ...
                <div className={classNames('u-clearfix', 'u-relative', 'dp-lembaga-content', {'u-hide': this.state.activeContent !== 'dompetdhuafa'})}>
                  <div className='u-relative u-mb2 u-center dp-lembaga-content-img'>
                ...
                <div className={classNames('u-clearfix', 'u-relative', 'dp-lembaga-content', {'u-hide': this.state.activeContent !== 'pkpu'})}>
                  <div className='u-relative u-mb2 u-center dp-lembaga-content-img'>
                    <img src={PkpuLogo} alt='' className='u-align-middle' />
                  </div>
                  <div className='dp-lembaga-content-text'>
                    <p className='u-h5 u-mt0 u-mb2'>PKPU adalah sebuah badan hukum berbentuk yayasan yang bersifat sosial dan kemanusiaan dan menjalankan kegiatan usahanya dalam bidang pengelolaan dana CSR dan dp-donasi tidak mengikat lainnya.</p>
                    <p className='u-h5 u-mt0 u-mb0'>
            ...
            <div className='dp--nominal'>
              <div className='form-group nominal u-mb2 u-block'>
                ...
                <div className='dp-select'>
                  <select className='dp-select form-control form-select'>
              ...
              <div className='dp--buy'>
                <div className='dp__checkbox checkbox'>
                  ...
                  <label onClick={this.handleInstantCheckbox.bind(this)} >
                    <span className='dp-checkbox'></span>
                    Bayar instan
                  </label>
                ...
                <button className='u-block u-center dp__btn btn--orange'>Salurkan Donasi</button>
