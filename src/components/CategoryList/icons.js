...
export default {
  ...
  pakaian: iconPakaian,
  'rumah-tangga': iconRumahTangga,
  kesehatan: iconKesehatan,
  olahraga: iconOlahraga,
  dapur: iconDapur,
  'handphone-tablet': iconHanphone,
  elektronik: iconElektronik,
  'komputer-aksesoris': iconKomputer,
  ...
  'office-stationery': iconOffice,
  buku: iconBuku,
  'film-musik-game': iconFilm,
  'produk-lainnya': iconProdukLain,
  pulsa: iconPulsa,
  saldo: iconSaldo,
