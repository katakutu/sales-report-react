...
export const CategoryList = () => (
  <div className="u-clearfix">
    <div className="category-list__holder u-clearfix">
      <div className="category-list__title">Gaya Hidup<div className="category-list__title-line"></div></div>
    ...
    <div className="category-list__holder u-clearfix">
      <div className="category-list__title">Teknologi<div className="category-list__title-line"></div></div>
    ...
    <div className="category-list__holder u-clearfix">
      <div className="category-list__title">Kategori lain<div className="category-list__title-line"></div></div>
    ...
    <div className="category-list__holder u-clearfix">
      <div className="category-list__title">Pembayaran & Top up<div className="category-list__title-line"></div></div>
